...
const adminController = require('../controllers/admin'); //ok
admin_router.get('/admin/:category_type/filter/:filter_by_time',adminController.getNomineesByTimeBasis); // ok
...
admin_router.get('/admin/:category_type/nominee/:nominee_name/filter/:filter_by_time',adminController.getVoterListByTimeBasis); // ok
