...
admin_router.get('/admin/:category_type/:filter_by_time',adminController.getNomineesByTimeBasis);
admin_router.get('/admin/:category_type/nominee/:nominee_name',adminController.getNomineeDetailsByName);
